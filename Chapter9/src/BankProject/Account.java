...
public class Account {
	 ...
	 */
	public Account(double bal, String fName, String lName, String street, String city, String province, String pCode) {
		balance = bal;
		cust = new Customer(fName, lName, street, city, province, pCode);
