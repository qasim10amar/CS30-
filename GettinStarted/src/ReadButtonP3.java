...
Program: ReadButtonP3.java          Last Date of this Revision: May 22, 2022
Purpose: Modify your code to only print when the button state changes.
...
public class ReadButtonP3 {
    ...
    public static void main(String[] args) throws Exception{
        ...
        while(true){
            ...
            if (redButton.getState() != redButton.getState()) {
            System.out.println("Red Button State: " + redButton.getState());
            
            } else if (greenButton.getState() != greenButton.getState()) {
