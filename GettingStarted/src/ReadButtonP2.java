...
Program: ReadButtonP2.java          Last Date of this Revision: May 22, 2022
Purpose: Modify your code to print the state of your green button
...
public class ReadButtonP2 {
    ...
    public static void main(String[] args) throws Exception{
        ...
        while(true){
            System.out.println("Greeb Button State: " + redButton.getState());
            Thread.sleep(1000);
