...
Program: ReadButton.java          Last Date of this Revision: May 22, 2022
Purpose: Modify the loop to repeat every 10ms, 1000ms, 5000ms. Note how the behavior of your program changes with the different times.​
...
public class ReadButton {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //Use your Phidgets | Here is where you use your Phidgets! This code checks the state of the button and prints true/false when the button is pressed/released. The sleep function means the button state is only checked every 1000 milliseconds. Sleeping is used to make it easier to read the console output and to put less stress on your CPU.
        while(true){
            ...
            //Checks every 5000 milliseconds
            //Thread.sleep(5000);
        }
    }
}
