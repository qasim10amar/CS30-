...
Program: BlinkLEDP2.java          Last Date of this Revision: May 22, 2022
Purpose: Modify your code so the LED flashes on and off 3 times.
...
public class BlinkLEDP2 {
	    ...
	    public static void main(String[] args) throws Exception{
	        ...
	        redLED.open(1000);
	        	...
	        	//Blinks the led on and off 3 times
	            for ( int i =0; i<3; i++) {
